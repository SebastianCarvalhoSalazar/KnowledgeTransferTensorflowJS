...
async function app(){
  ...
  while (true) {
    ...
    const classes = ["Untrained", "Gato", "Perro" , "Celular", "Rostro1","Rostro2"]
    ...
    // Elimina el tensor para liberar la memoria.
    img.dispose();

    // Dar un poco de espacio esperando a que se dispare el siguiente cuadro de animación.
